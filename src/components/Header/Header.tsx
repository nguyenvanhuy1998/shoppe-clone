    ...
    <div className='pb-5 pt-2 bg-[linear-gradient(#ee4d2d,#ff7337)] text-white'>
      <div className='container'>
        <div className='flex justify-end'>
            ...
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-300'>
                <div className='flex flex-col py-2 px-3 pr-28 pl-3'>
                  <button className='py-2 px-3 hover: hover:text-orange text-left'>Tiếng Việt</button>
          ...
          <Popover
            className='flex items-center py-1 hover:text-gray-300 ml-6'
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-300'>
                <Link
                  to='/profile'
          ...
          >
            <div className='w-5 h-5 mr-2 flex-shrink-0'>
              <img
                src='https://down-vn.img.susercontent.com/file/7ae7e0676afa329718b0507ed5ff5dde_tn'
                alt='avatar'
                className='w-full h-full object-cover rounded-full'
              />
            </div>
            <div>nguyenvanhuy</div>
          </Popover>
        </div>
        <div className='grid grid-cols-12 gap-4 mt-4 items-end'>
          ...
          <form className='col-span-9'>
            <div className='bg-white rounded-sm p-1 flex'>
              <input
                type='text'
                name='search'
                className='tex-black px-3 py-2 flex-grow border-none outline-none bg-transparent'
          ...
          <div className='col-span-1 justify-self-end '>
            <Popover
              renderPopover={
                // Popover
                <div className='bg-white relative shadow-md rounded-sm border border-gray-300 max-w-[400px] text-sm'>
                  {/* Container */}
                  <div className='p-2'>
                    {/* Title */}
                    ...
                    <div className='mt-5'>
                      ...
                      <div className='mt-4 flex'>
                        ...
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>₫469.00</span>
                        </div>
                      </div>
                      {/* Item 2 */}
                      <div className='mt-4 flex'>
